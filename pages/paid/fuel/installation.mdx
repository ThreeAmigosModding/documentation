...
- [ox_target](https://github.com/communityox/ox_target/releases/latest) (Highly Recommended)
...
- [ox_inventory](https://github.com/communityox/ox_inventory/releases/latest) (Highly Recommended) 
