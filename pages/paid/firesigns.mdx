...
## Installation
1. Download or update `ox_lib`. Make sure to download the [release](https://github.com/communityox/ox_lib/releases/latest)
    - Download or update `ox_target` (optional). Make sure to download the [release](https://github.com/communityox/ox_target/releases/latest)
...
You can easily change all locales in the `locales` directory. Edit the .json file of the respective language you want to change. Clients are able to set their preferred language via `/ox_lib` command. See more information [here](https://communityox.dev/ox_lib/Modules/Locale/Shared)
