    ...
    <Tabs.Tab>
        ```lua
            ...
            config.interactions = {
                ...
                -- Additionally, you can add more stuff to be disable (ie phone) to the `blockActions` function in bridge/config/client.lua
...
Included are about a dozen hook functions in the `bridge/config` directory, here you can integrate various functions.
