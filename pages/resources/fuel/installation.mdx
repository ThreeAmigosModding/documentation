...
- [ox_target](https://github.com/overextended/ox_target/releases/latest) (Highly Recommended)
...
- [ox_inventory](https://github.com/overextended/ox_inventory/releases/latest) (Highly Recommended) 
